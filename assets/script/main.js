...
document.addEventListener("DOMContentLoaded", async () => {
   ...
   books.forEach((book) =>{
    ...
    searchBar.addEventListener('keyup', async (e)=>{
        ...
        const books = await getAllBooks()
        books.forEach((book)=>{
            if(book.name.toLowerCase().trim().includes(searchBar.value.toLowerCase().trim())){
                booksWrapper.innerHTML += `
                <div class="col-3 col-md-6 col-sm-12">
                <div class="box">
                    <div class="box-img">
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    coffees.forEach((coffee) =>{
     ...
     <div class="box">
         ...
         <div class="box-btn">
             <button id="delete" type="button" class="btn" style="color: #ffffff; background-color:#a96030; border: none;"><i class="fa-solid fa-trash"></i></button>
             <button id="cart" class="btn btn-warning" href="detail.html?id=${coffee.id}"  style="color: #ffffff; background-color:#88766a; border: none;"><i class="fa-solid fa-cart-shopping" style="color: #fcfcfc;"></i></button>
         </div>
     </div>
 </div>
     `
